...
public class App {
    public static void main(String[] args) {
        ...
        try {book = new SimpleProduct("   ", 500);} catch (IllegalArgumentException e) {System.out.println("Ошибка при создании продукта: " + e.getMessage());}
        ...
        try {copyBook = new DiscountedProduct("Тетрадь", 30, -5);} catch (IllegalArgumentException e) {System.out.println("Ошибка при создании продукта: " + e.getMessage());}
